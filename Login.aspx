<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Sistema_de_Requisiciones.Login" %>
...
<body>
    <asp:Panel ID="PanelFondo" runat="server" CssClass="wrapper">
        <asp:Panel ID="Panel1" runat="server" CssClass="wrapper-content">
            <h1 style="color: white">SISTEMA WEB DE SOLICITUDES </h1>
