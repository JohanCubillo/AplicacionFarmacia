<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Administrador.aspx.cs" Inherits="Sistema_de_Requisiciones.Administrador" %>
                 ...
                 <div class="container-table">
                    ...
                    <div style="margin: 20px">
                        <div style="width: 100%; height: 350px; overflow: scroll">
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceAdmin" runat="server" ConnectionString="<%$ ConnectionStrings:RequisicionesConnectionString3 %>" DeleteCommand="DELETE FROM [usuario] WHERE [usuarioId] = @usuarioId" InsertCommand="INSERT INTO [usuario] ([cedula], [nombre], [apellido], [telefono], [estado], [mail]) VALUES (@cedula, @nombre, @apellido, @telefono, @estado, @mail)" SelectCommand="SELECT [usuarioId], [cedula], [nombre], [apellido], [telefono], [estado], [mail] FROM [usuario]" UpdateCommand="UPDATE [usuario] SET [cedula] = @cedula, [nombre] = @nombre, [apellido] = @apellido, [telefono] = @telefono, [estado] = @estado, [mail] = @mail WHERE [usuarioId] = @usuarioId">
                                <DeleteParameters>
